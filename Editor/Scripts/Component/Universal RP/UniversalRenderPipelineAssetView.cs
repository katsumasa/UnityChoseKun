...
namespace Utj.UnityChoseKun
{
    ...
    namespace Editor 
    {
        namespace Rendering
        {
            namespace Universal
            {
                public class UniversalRenderPipelineAssetView : RenderPipelineAssetView
                {
                    static class Styles
                    {
                    ...
                    {
                        if(universalRenderPipelineAssetKun == null)
                        {
                            return false ;
                        }
                    ...
                    bool DrawLighting(UniversalRenderPipelineAssetKun universalRenderPipelineAssetKun)
                    {
                        ...
                        if (mLightFoldout)
                        {
                            ...
                            EditorGUI.indentLevel++;
                            {
                                ...
                                EditorGUI.BeginDisabledGroup(disableGroup);
                                EditorGUILayout.EnumPopup(Styles.ShadowResolution, (Engine.Rendering.Universal.ShadowResolution)universalRenderPipelineAssetKun.mainLightShadowmapResolution);
                                EditorGUI.EndDisabledGroup();
                            }
                            EditorGUI.indentLevel--;
                            EditorGUILayout.Space();
                            ...
                            EditorGUI.indentLevel++;
                            {
                                ...
                                EditorGUI.BeginDisabledGroup(disableGroup);
                                EditorGUILayout.EnumPopup(Styles.ShadowAtlasReslosution, (Engine.Rendering.Universal.ShadowResolution)universalRenderPipelineAssetKun.additionalLightsShadowmapResolution);
                    ...
                    void DrawCascadeSliders(UniversalRenderPipelineAssetKun universalRenderPipelineAssetKun, int splitCount, bool useMetric, float baseMetric)
                    {
